...
const INSEAMS = ['قصير ٢٧ بوصة', 'عادي ٣٠ بوصة', 'طويل ٣٣ بوصة'];
...
const PHOTOS = {
  'm-scrub-blue-front': { src: 'assets/img/m-scrub-blue-front.jpg', color: 'أزرق سماوي',
    alt: 'ممرّض يرتدي طقم سكراب أزرق كامل بجيوب جانبية، لقطة أمامية بكامل الطول على خلفية بيضاء' },
  'm-scrub-blue-lean':  { src: 'assets/img/m-scrub-blue-lean.jpg', color: 'أزرق سماوي',
    alt: 'ممرّض بطقم سكراب أزرق يقف مسنداً ظهره إلى باب زجاجي في ممرّ مستشفى' },
  'm-underscrub-a':     { src: 'assets/img/m-underscrub-a.jpg', color: 'أزرق سماوي',
    alt: 'ممرّض يرتدي قميص سكراب أزرق فوق طبقة تحت-السكراب بيضاء بأكمام طويلة' },
  'm-underscrub-b':     { src: 'assets/img/m-underscrub-b.jpg', color: 'أزرق سماوي',
    alt: 'ممرّض بطقم أزرق وطبقة داخلية بيضاء يفحص صورة أشعة' },
  'm-scrub-white':      { src: 'assets/img/m-scrub-white.jpg', color: 'أبيض',
    alt: 'طبيب بطقم سكراب أبيض بكامل الطول يحمل حقيبة إسعافات' },
  'm-labcoat':          { src: 'assets/img/m-labcoat.jpg', color: 'أبيض',
    alt: 'طبيب يرتدي معطف مختبر أبيض بجيوب سفلية، لقطة من الخصر إلى الأعلى' },

  'w-scrub-teal-a':     { src: 'assets/img/w-scrub-teal-a.jpg', color: 'أزرق كاريبي',
    alt: 'ممرّضة بقميص سكراب أزرق كاريبي ويداها في الجيبين السفليين' },
  'w-scrub-teal-b':     { src: 'assets/img/w-scrub-teal-b.jpg', color: 'أزرق كاريبي',
    alt: 'ممرّضة بقميص سكراب أزرق كاريبي تستعمل سمّاعة طبية' },
  'w-scrub-green':      { src: 'assets/img/w-scrub-green.jpg', color: 'أخضر جراحي',
    alt: 'ممرّضة بقميص سكراب أخضر جراحي بجيب صدر، على خلفية فاتحة' },
  'w-scrub-blue':       { src: 'assets/img/w-scrub-blue.jpg', color: 'أزرق سماوي',
    alt: 'ممرّضة بطقم سكراب أزرق كامل، تظهر الجيوب الأمامية وجيب الساق' },
  'w-scrub-pewter':     { src: 'assets/img/w-scrub-pewter.jpg', color: 'رمادي بيوتر',
    alt: 'ممرّضة بطقم سكراب رمادي بيوتر على خلفية بيضاء' },
  'w-labcoat':          { src: 'assets/img/w-labcoat.jpg', color: 'أبيض',
