/* vitaS — الأدوات المشتركة بين كل الصفحات: التنسيق والرسوم.
   نُقلت من app.js كما هي دون تعديل. */

/* vitaS — العرض والتفاعل
   الرسوم كلها SVG مكتوبة هنا وتُلوَّن من نظام الألوان، فلا توجد صور نائبة. */

const $  = (s, r = document) => r.querySelector(s);
const $$ = (s, r = document) => [...r.querySelectorAll(s)];
const money = n => new Intl.NumberFormat('ar-EG', { maximumFractionDigits: 0 }).format(n);
const pad2  = n => money(n).padStart(2, '٠');
/* دالة مستقلة للسعر: money() تُستعمل أيضاً للوزن والجيوب والكمية وأرقام المخطّط،
   وإضافة صيغة عملة إليها كانت ستفسدها كلها. */
const price = n => money(n) + ' د.ع';
...
/* ============ رسوم القطع ============ */
/* أسلوب الرسم: خط خارجي بالحبر، درزات متقطّعة، ولوح ظل خفيف — كما في الرسم الفني. */
